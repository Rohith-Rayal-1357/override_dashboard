...
def main():
    ...
    if not module_tables_df.empty:
        ...
        if not table_info_df.empty:
            ...
            with tab1:
                ...
                if not source_df.empty:
                    ...
                    # Render the DataFrame with st.data_editor
                        ...
                        try:
                            ...
                            if not changed_rows.empty:
                                for index, row in changed_rows.iterrows():
                                    ...
                                    # 2. Insert the new record in source table
                                    insert_into_source_table(selected_table, row, new_value, editable_column_upper)

                                    # 3. Insert record into override table
        ...
        st.info("No tables available for the selected module.")
